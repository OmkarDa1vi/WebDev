...
(1, 'Laptops & Computers', 'Portable and desktop computers, including gaming rigs and workstations.'),
(2, 'Smartphones & Tablets', 'Mobile phones, iPads, and Android tablets with latest cellular tech.'),
(3, 'Audio & Headphones', 'Bluetooth speakers, noise-canceling headphones, and home theater systems.'),
(4, 'Cameras & Photography', 'DSLRs, mirrorless cameras, lenses, and action cameras like GoPro.'),
(5, 'Wearable Technology', 'Smartwatches, fitness trackers, and health monitoring devices.'),
(6, 'Smart Home', 'Smart bulbs, security cameras, and voice-controlled assistants.'),
(7, 'Television & Video', '4K OLED/QLED TVs, projectors, and streaming devices.'),
(8, 'Gaming Consoles', 'PlayStation, Xbox, Nintendo Switch, and related peripherals.'),
(9, 'Computer Peripherals', 'Keyboards, mice, monitors, and external hard drives.'),
(10, 'Home Appliances', 'Tech-enabled kitchen appliances, vacuum cleaners, and air purifiers.');
...
(101, 'MacBook Pro 14', 1, 169900.00),
